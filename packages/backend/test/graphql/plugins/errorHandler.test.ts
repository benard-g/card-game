...
import { LOCAL_SERVICE_LOCATOR_KEY } from '../../../src/constants/api';
import { registerErrorHandler } from '../../../src/graphql/plugins/registerErrorHandler';
...
describe('graphql/plugins/errorHandler', () => {
  ...
  it('should return a graphql error response', async () => {
    ...
    expect(loggerMock.info).toHaveBeenCalledWith('[graphql] Error', {
