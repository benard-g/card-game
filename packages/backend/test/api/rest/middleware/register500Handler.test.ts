...
import { register500Handler } from '../../../../src/api/rest/middleware/register500Handler';
import { registerServiceLocatorMiddleware } from '../../../../src/api/rest/middleware/registerServiceLocatorMiddleware';
...
describe('api/rest/middleware/register500Handler', () => {
